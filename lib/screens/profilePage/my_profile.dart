...
import 'package:instagram_ui/widgets/profile_page/my_photo.dart';
...
class MyProfilePage extends StatelessWidget {
  ...
  myProfileWidget(BuildContext context) {
    return Container(
      ...
      child: Padding(
        padding:
            const EdgeInsets.only(left: 18, right: 18, bottom: 10, top: 18),
        child: Column(
          ...
          children: [
            ...
            const Padding(
              ...
              child: Text(
                TextConstants.ecembostancioglu1,
                      ...
                      children: [
                        CircleAvatar(
                          ...
                          child: CircleAvatar(
                            radius: 27,
                            backgroundImage:
                                const AssetImage('assets/white_bg.png'),
                            child: CircleAvatar(
                              radius: 25,
                              backgroundImage:
                                  AssetImage(highlightsItem[index].thumbnail),
                            ),
                          ),
                        ),
                        Padding(
