...
class StoryHighlights {
  ...
  StoryHighlights({required this.thumbnail, required this.title});
}

List<StoryHighlights> highlightsItem = [
  StoryHighlights(
      thumbnail: 'assets/santorini.png', title: TextConstants.santorini),
  StoryHighlights(
      thumbnail: 'assets/budapest.png', title: TextConstants.budapest),
